...
public class DeliveryInfoSender extends ProcessingThread {
	private static String dlr_status = "DELIVRD";
	public static int counter = 0;
	/*
	 * private static String sub_time = "1611061722"; private static String done_time = "1611061723"; private static String done_time_exp =
	 * "1611071821";
	 */
	...
	private void deliver(DeliveryInfoEntry entry) {
		...
		// msg += "stat:" + Simulator.DLR_STATUS + " ";
		msg += "stat:" + StartSim.DLR_STATUS + " ";
		msg += "err:" + StartSim.ERROR_CODE + " ";
